...
use web_parser_rust::parsers::{
    ...
    parser_asia::ParserAsia, parser_baltika::ParserBaltika, parser_beeline::ParserBeeline,
    ...
    parser_smp::ParserSmp, parser_tgk14::ParserTgk14, parser_uds::ParserUds, parser_azer::ParserAzer,
};
