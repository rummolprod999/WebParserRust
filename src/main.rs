...
use web_parser_rust::parsers::{
    parser_ahstep::ParserAhstep, parser_alfa::ParserAlfa, parser_asia::ParserAsia,
    parser_baltika::ParserBaltika, parser_beeline::ParserBeeline, parser_eldorado::ParserEldorado,
