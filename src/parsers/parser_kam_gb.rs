...
use crate::tenders::tender_kamgb::TenderKamgb;
use crate::tenders::tenders::WebTender;
use crate::toolslib::datetimetools;
use crate::toolslib::httptools;
use crate::toolslib::toolslib;
use crate::toolslib::toolslib::FindExt;
use std::error;
...
impl<'a> ParserKamgb<'a> {
    ...
    fn parser_tender(&mut self, tender: Node) -> Result<(), Box<error::Error>> {
        ...
        let end_date_t = end_date_tt
            .text()
            .replace("Срок приёма предложения, до", "")
            .trim()
            .to_string();
        ...
        let tn: TenderKamgb = TenderKamgb {
            ...
            etp_url: "http://www.kamgb.ru/".to_string(),
            href,
            pur_num,
