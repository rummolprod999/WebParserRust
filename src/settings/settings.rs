...
impl fmt::Display for Args {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Args::Mosobl => write!(f, "mosobl"),
            Args::Baltika => write!(f, "baltika"),
            Args::Alfa => write!(f, "alfa"),
            Args::Smp => write!(f, "smp"),
            Args::Am => write!(f, "am"),
            Args::Azer => write!(f, "azer"),
            Args::Dochki => write!(f, "dochki"),
            Args::Ungi => write!(f, "ungi"),
            Args::Ruscoal => write!(f, "ruscoal"),
            Args::Azs => write!(f, "azs"),
            Args::Nordstar => write!(f, "nordstar"),
            Args::Ingrad => write!(f, "ingrad"),
            Args::Kaprem => write!(f, "kaprem"),
            Args::Snhz => write!(f, "snhz"),
        }
    }
}
...
pub fn check_args() -> Args {
    let arguments =
        "Please, use this arguments: mts, beeline, nefaz, kamgb, uds, megafon, ahstep, salavat, nornic, pewete, quadra, tgk14, medsi, lada, asia, eldorado, mosobl, baltika, alfa, smp, am, azer, dochki, ungi, ruscoal, azs, nordstar, ingrad, kaprem, snhz";
    ...
    let a = match matches.value_of("argument") {
        ...
        Some(s) => match s {
            ...
            "lada" => Args::Lada,
            "asia" => Args::Asia,
            "eldorado" => Args::Eldorado,
            "mosobl" => Args::Mosobl,
            "baltika" => Args::Baltika,
            "alfa" => Args::Alfa,
            "smp" => Args::Smp,
            "am" => Args::Am,
            "azer" => Args::Azer,
            "dochki" => Args::Dochki,
            "ungi" => Args::Ungi,
            "ruscoal" => Args::Ruscoal,
            "azs" => Args::Azs,
            "nordstar" => Args::Nordstar,
            "ingrad" => Args::Ingrad,
            "kaprem" => Args::Kaprem,
            "snhz" => Args::Snhz,
            _ => {
