...
pub struct TenderUds<'a> {
    ...
    pub date_bidding: DateTime<FixedOffset>,
    pub connect_string: &'a String,
}

impl<'a> WebTender for TenderUds<'a> {
...
impl<'a> TenderUds<'a> {
    ...
    fn insert_purchase_object(
        ...
        (pool.prep_exec("INSERT INTO purchase_object SET id_lot = :id_lot, id_customer = :id_customer, name = :name", params! {"id_lot" => id_lot, "id_customer" => id_customer, "name" => &self.pur_obj}))?;
        Ok(())
    }
}
